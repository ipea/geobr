...
- [`read_intermediate_region()`](https://ipea.github.io/geobr/dev/reference/read_intermediate_region.md)
...
- [`read_micro_region()`](https://ipea.github.io/geobr/dev/reference/read_micro_region.md)
  : Download spatial data of micro regions
- [`read_meso_region()`](https://ipea.github.io/geobr/dev/reference/read_meso_region.md)
...
- [`read_state()`](https://ipea.github.io/geobr/dev/reference/read_state.md)
...
- [`read_weighting_area()`](https://ipea.github.io/geobr/dev/reference/read_weighting_area.md)
...
- [`read_amazon()`](https://ipea.github.io/geobr/dev/reference/read_amazon.md)
  : Download spatial data of Brazil's Legal Amazon
- [`read_biomes()`](https://ipea.github.io/geobr/dev/reference/read_biomes.md)
  : Download spatial data of Brazilian biomes
- [`read_conservation_units()`](https://ipea.github.io/geobr/dev/reference/read_conservation_units.md)
...
- [`read_semiarid()`](https://ipea.github.io/geobr/dev/reference/read_semiarid.md)
  : Download spatial data of the Brazilian Semiarid region

## Urban

- [`read_neighborhood()`](https://ipea.github.io/geobr/dev/reference/read_neighborhood.md)
...
- [`grid_state_correspondence_table`](https://ipea.github.io/geobr/dev/reference/grid_state_correspondence_table.md)
