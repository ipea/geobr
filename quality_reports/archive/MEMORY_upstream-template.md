> **ARCHIVED 2026-08-31.** These are the learnings of the upstream template repo
> (`pedrohcgs/claude-code-my-workflow`), inherited verbatim by the geobr fork. They concern that
> repo's own governance, surface-sync scripts, and lecture/manuscript skills — none of which
> exist here. Kept for reference only. The live file is [MEMORY.md](../../MEMORY.md).
