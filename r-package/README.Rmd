...
including [duckdb_demo.ipynb](https://github.com/ipea/geobr/blob/master/python-package/examples/duckdb_demo.ipynb).
...
please check this [guide](https://github.com/ipea/geobr/blob/master/CONTRIBUTING.md) 
...
Brazil. The package received support from Instituto Todos pela Saúde (ITpS). If you want to cite this package, you can cite it as:
