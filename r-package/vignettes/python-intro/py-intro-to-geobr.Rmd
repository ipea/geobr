...
This allows data to be analyzed with DuckDB, enabling efficient out-of-memory spatial operations. Users can also leverage a DuckDB power-user API with auto-resolving `query()`, as shown in this [example](https://github.com/ipea/geobr/blob/master/python-package/examples/duckdb_demo.ipynb).
